      ...
      child: BlocBuilder<TestHistoryBloc, TestHistoryState>(
        builder: (BuildContext context, TestHistoryState state) {
          ...
          if (state.status == TestHistoryStatus.loaded) {
            ...
            return state.testHistories.isEmpty
                ? Center(
                    child: Text(
                      'No available data', //todo change logic
                ...
                : RefreshIndicator(
                    onRefresh: () async {
                      context.read<TestHistoryBloc>().add(
                            LoadTestHistoryEvent(user: user),
                          );
                    },
                    color: AppColors.of(context).black,
                                    ...
                                    : Column(
                                        children: <Widget>[
                                          Row(
                                            ...
                                            children: <Widget>[
                                              ItemInfoWidget(
                                                roomName: testHistoryItemLeft
                                                    .roomName,
                                                itemHigh: testHistoryItemLeft
                                                    .itemHeight,
                                                itemWidth: testHistoryItemLeft
                                                    .itemWidth,
                                                itemLength: testHistoryItemLeft
                                                    .itemLength,
                                                isTestPassed:
                                                    testHistoryItemLeft
                                                        .isTestPassed,
                                              ...
                                              if (testHistoryItemRight != null)
                                                ItemInfoWidget(
                                                  roomName: testHistoryItemRight
                                                      .roomName,
                                                  itemHigh: testHistoryItemRight
                                                      .itemHeight,
                                                  itemWidth:
                                                      testHistoryItemRight
                                                          .itemWidth,
                                                  itemLength:
                                                      testHistoryItemRight
                                                          .itemLength,
